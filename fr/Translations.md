...
# Translations
> This way of translating the wiki is temporary. `KK964` on the streamer.bot Discord is working on a better solution for this, but that will take a some time to do, so **don't** expect that being released tomorrow. 
> 
> {.is-warning}
...
Then when you have downloaded the file translate it. Done with translating it?, fill in this google form below
...
Language examples of translated by *example#0000 ترجمه*{.translation-badge} (AR)
